# Django settings for security_website project.
#coding=utf-8
import os.path
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ustc2014',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'wre-@sfk63*8^@j&c1@+321^=nx+duhc2_w0vl^ru)!w(tsedd'
